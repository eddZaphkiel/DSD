...
ARCHITECTURE structure OF asincrono IS
...
SIGNAL \TFF0|Q_int~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \U_DIV|LessThan0~0_combout\ = ((!\U_DIV|count\(20)) # (!\U_DIV|count\(22))) # (!\U_DIV|count\(21))
...
PORT MAP (
	datab => \U_DIV|count\(21),
	datac => \U_DIV|count\(22),
	datad => \U_DIV|count\(20),
	combout => \U_DIV|LessThan0~0_combout\);

-- Location: LCCOMB_X32_Y9_N28
\U_DIV|LessThan0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \U_DIV|LessThan0~1_combout\ = (((!\U_DIV|count\(17) & !\U_DIV|count\(16))) # (!\U_DIV|count\(18))) # (!\U_DIV|count\(19))
...
PORT MAP (
	dataa => \U_DIV|count\(17),
	datab => \U_DIV|count\(16),
	datac => \U_DIV|count\(19),
	datad => \U_DIV|count\(18),
	combout => \U_DIV|LessThan0~1_combout\);

-- Location: LCCOMB_X31_Y10_N16
\U_DIV|LessThan0~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \U_DIV|LessThan0~4_combout\ = (!\U_DIV|count\(7) & (!\U_DIV|count\(9) & (!\U_DIV|count\(8) & !\U_DIV|count\(10))))
...
-- Equation(s):
-- \U_DIV|LessThan0~2_combout\ = (((!\U_DIV|count\(3)) # (!\U_DIV|count\(2))) # (!\U_DIV|count\(0))) # (!\U_DIV|count\(1))
...
-- Equation(s):
-- \U_DIV|LessThan0~7_combout\ = (\U_DIV|LessThan0~1_combout\) # ((!\U_DIV|count\(15) & (!\U_DIV|count\(17) & \U_DIV|LessThan0~6_combout\)))
...
PORT MAP (
	dataa => \U_DIV|count\(23),
	datab => \U_DIV|count\(24),
	datac => \U_DIV|LessThan0~0_combout\,
...
PORT MAP (
	...
	datac => \U_DIV|LessThan0~8_combout\,
...
\TFF0|Q_int~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \TFF0|Q_int~feeder_combout\ = \TFF0|Q_int~0_combout\
...
-- pragma translate_on
PORT MAP (
	datac => \TFF0|Q_int~0_combout\,
	combout => \TFF0|Q_int~feeder_combout\);
